...
import { Award, Bell, BriefcaseBusiness, Check, ChevronRight, Download, FileText, GraduationCap, HelpCircle, Info, PenLine, Save, ScanLine, Settings, ShieldCheck, Wallet } from "lucide-react";
...
export function MyPage() {
  ...
  </div><ConfirmDialog open={confirmLogout} title="退出登录" description="只会清除当前登录 session。简历、赛事经历、课程、证书和其它长期账号资产不会被删除。退出后仍可浏览公共平台。" cancelText="取消" confirmText="确认退出" onCancel={() => setConfirmLogout(false)} onConfirm={logout} /></PublicShell>;
}
