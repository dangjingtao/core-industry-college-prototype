...
function PhoneVerification({ phone, originalPhone, originalVerified, onPhoneChange, onVerifiedChange }: { phone: string; originalPhone: string; originalVerified: boolean; onPhoneChange: (value: string) => void; onVerifiedChange: (verified: boolean) => void }) {
  const [sent, setSent] = useState(false);
  const [code, setCode] = useState("");
  const alreadyVerified = originalVerified && phone === originalPhone;
