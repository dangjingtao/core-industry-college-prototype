...
test("F003 external content support and course sharing expose real handoffs", async ({ page }) => {
  ...
  // Prototype content entries may change copy or defer the final public-account URL.
  // Keep the regression focused on the route existing rather than one legacy CTA label.
