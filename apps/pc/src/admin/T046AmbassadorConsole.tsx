  ...
  return <>
    ...
    >
      <div className="rounded-container bg-primary-container p-5 text-center">
        ...
        <p className="mt-4 text-xs text-text-secondary">扫码进入 Mobile 大使申请入口</p>
