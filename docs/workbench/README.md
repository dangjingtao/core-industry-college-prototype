...
本轮沿用现有 T 系列编号，不另起任务体系：

1. [`T043-核心大使计划共享业务模型.md`](./T043-核心大使计划共享业务模型.md)｜共享业务模型与活动状态；
2. [`T044-核心大使申请组队与点亮.md`](./T044-核心大使申请组队与点亮.md)｜App：申请、组队与点亮；
3. [`T045-专属推广码与团队推广成果.md`](./T045-专属推广码与团队推广成果.md)｜App：专属推广码与团队推广成果；
4. [`T046-核心大使计划运营工作台.md`](./T046-核心大使计划运营工作台.md)｜PC：接入现有运营控制面；
5. [`T047-核心大使计划联动与验收.md`](./T047-核心大使计划联动与验收.md)｜前后台联动、生命周期与最终验收。

推荐顺序：`T043 → (T044 ∥ T046) → T045 → T047`。
